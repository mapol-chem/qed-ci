...
0 1
    O      0.000000000000   0.000000000000  1000000000.93148378068
    H      0.000000000000  -0.790689573744  1000000001.543701060715
    H      0.000000000000   0.790689573744  1000000001.543701060715
no_reorient
symmetry c1
"""
...
E_origin = h2o_dict_origin["CQED-RHF ENERGY"]
E_shift = h2o_dict_shifted["CQED-RHF ENERGY"]

print(F'E_origin {E_origin:.12f}')
print(F'E_shift  {E_shift:.12f}')
assert np.isclose(E_origin, E_shift, 1e-10, 1e-10)
...
assert np.allclose(F_origin, F_shifted, 1e-10, 1e-10)
